...
// a resuable function to format currency
...
console.log(+'23'); // converts 23 to a number
...
console.log(Math.max(5, 18, '23', 2, 11));
console.log(Math.max(5, 18, '23px', 2, 11));

console.log(Math.min(5, 18, 23, 2, 11));

console.log(Math.PI * Number.parseFloat('10px') ** 2); // calculates the area of a circle with 10px radius
...
console.log(238764890876542679976678383939n);
console.log(BigInt(234568));

// Operations
console.log(10000n + 10000n);
console.log(238764890876542679976678383939n * 10000n);
// console.log(Math.sqrt(16n));

const huge = 26378975256671827363n;
const num = 25;
...
console.log(new Date('Apr 24 2021 12:26:26'));
...
const day1 = calcDaysPassed(new Date(2037, 4, 30), new Date(2037, 4, 8));
console.log(day1);
*/
...
console.log('Canada: ', new Intl.NumberFormat('ar-Sy', options).format(num));
